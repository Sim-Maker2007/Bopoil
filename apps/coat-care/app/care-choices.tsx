...
import { careLabel, coatOptions, matchingCare, sizeKeyFromLabel, sizeOptions, suggestedCoat } from "../lib/care-options";
...
export function CareChoices({ pet, services, currency, contactPhone, onChoose, onBack }: {
  ...
  const [size, setSize] = useState(sizeKeyFromLabel(pet.sizeLabel));
